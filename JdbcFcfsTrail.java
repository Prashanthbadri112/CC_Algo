...
public class JdbcFcfsTrail {
    ...
    private static ResultSet getCloudletPropertiesFromDatabase() {
        try {
            ...
            String query = "SELECT length, filesize, outputsize FROM FCFS";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (id < 3) { // Define the maximum number of cloudlets to add
            ...
            Log.printLine("CloudSim FCFS finished!");
        } catch (Exception e) {
            e.printStackTrace();
