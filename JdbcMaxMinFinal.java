...
public class JdbcMaxMinFinal {
	...
	public static void main(String[] args) {
		...
		Log.printLine("MaxMin scheduler");
	        ...
	        try {
	        	// First step: Initialize the CloudSim package. It should be called
	            	...
	            	vmid++;
	            	Vm vm1 = new Vm(vmid, brokerId, mips, pesNumber, 512, bw, 20000, vmm, new CloudletSchedulerTimeShared());
                        
                        vmid++;
	            	Vm vm2 = new Vm(vmid, brokerId, mips, pesNumber, 1024, bw, 30000, vmm, new CloudletSchedulerTimeShared());
                        
                        vmid++;
	            	Vm vm3 = new Vm(vmid, brokerId, mips, pesNumber, 2048, bw, 40000, vmm, new CloudletSchedulerTimeShared());
           ...
           Collections.sort(cloudletList, Comparator.comparingLong(Cloudlet::getCloudletLength));
            broker.submitCloudletList(cloudletList);
                        ...
                        broker.bindCloudletToVm(cloudletList.get(0).getCloudletId(), vm2.getId());
                        broker.bindCloudletToVm(cloudletList.get(1).getCloudletId(), vm2.getId());
                        broker.bindCloudletToVm(cloudletList.get(2).getCloudletId(), vm1.getId());
                        broker.bindCloudletToVm(cloudletList.get(3).getCloudletId(), vm0.getId()); 
	            	...
	            	Log.printLine("MaxMinScheduler finished!");
	        }
	        catch (Exception e) {
	            e.printStackTrace();
